...
class RemoteDataSource {
    ...
    fun getMovies(callback: LoadMoviesCallback) {
        idling.increment()
        ApiService.getService().getListMovies(1).enqueue(object : retrofit2.Callback<MovieResponse> {
    ...
    fun getDetailMovies(id: Int?,callback: LoadDetailMoviesCallback) {
        idling.increment()
        ApiService.getService().getDetailMovies(id!!).enqueue(object : retrofit2.Callback<DetailMovie> {
    ...
    fun getDetailTvShow(id: Int?,callback: LoadDetailTvCallback) {
        idling.increment()
        ApiService.getService().getDetailTVShows(id!!).enqueue(object : retrofit2.Callback<DetailTvShow> {
